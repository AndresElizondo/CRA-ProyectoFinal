...
void Init_UI_FW(void)
{
	...
	UI_Data.Dir = 0;                        // 0 giro manecillas | 1 giro en contra manecillas
    float rpmScaleMax = 0.4;                // Escala del rpm maximo (4000)
    float rpmScaleMin = rpmScaleMax * 0.1;
    UI_Data.maxSpeedRpm = 4000*rpmScaleMax;
    UI_Data.minSpeedRpm = 4000*rpmScaleMin; // Era un valor de 500
