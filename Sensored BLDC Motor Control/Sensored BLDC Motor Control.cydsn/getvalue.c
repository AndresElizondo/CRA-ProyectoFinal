...
uint16 ReadRpmRef(void)
{
    ...
    return speedGiven;
//    uint16 speedSampleCur = MIN_SPEED_REF_ADC_VALUE; //(ADC_SAR_Seq_1_GetResult16(SPEED_REF_CHAN) & 0x0FFF);  
//    uint16 speedRange = UI_Data.maxSpeedRpm - UI_Data.minSpeedRpm;
//    uint16 speedGiven = 0;
//    
//    
...
//        speedSampleCur = MIN_SPEED_REF_ADC_VALUE;
//    
//    uint16 velocidadMotor = speedSampleCur - MIN_SPEED_REF_ADC_VALUE;
//    speedGiven = UI_Data.minSpeedRpm + ((uint32)(velocidadMotor * speedRange) / 
//                                           (MAX_SPEED_REF_ADC_VALUE - MIN_SPEED_REF_ADC_VALUE));
//   
//    return speedGiven;
}
